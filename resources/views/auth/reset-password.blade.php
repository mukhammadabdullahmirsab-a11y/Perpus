...
<head>
    ...
    <title>Sandi Baru Admin - Perpustakaan</title>
    ...
    <div class="w-full max-w-md mx-auto px-4 relative" style="z-index: 10;">
        ...
        <div class="p-8 rounded-2xl" style="background: var(--bg-card); backdrop-filter: blur(20px); border: 1px solid var(--border-main);">
            ...
            <div class="text-center mb-8">
                <div class="w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-4" style="background: linear-gradient(135deg, #10b981, #3b82f6);">
                ...
                <h2 class="text-2xl font-black" style="color: var(--text-primary);">SANDI BARU</h2>
                <p style="color: var(--text-muted); font-size: 14px;">Identitas admin diverifikasi</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-4">
                    <label class="block text-xs font-bold mb-2" style="color: var(--text-secondary);">Sandi Baru</label>
                    <input type="password" name="password"
                           class="w-full px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500"
                ...
                <div class="mb-6">
                    <label class="block text-xs font-bold mb-2" style="color: var(--text-secondary);">Konfirmasi Sandi Baru</label>
            ...
            <div class="text-center mt-6">
                <a href="{{ route('login') }}" class="text-sm font-semibold no-underline" style="color: var(--text-muted);">Batal dan kembali ke Login Admin</a>
            </div>
        </div>
    </div>
</body>
