...
<body class="flex items-center justify-center" style="min-height: 100vh;">
    ...
    <div class="w-full max-w-md p-6 relative" style="z-index: 10;">
        ...
        <div class="text-center mb-8">
            <div class="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" style="background: linear-gradient(135deg, #10b981, #3b82f6);">
            ...
            <h1 class="text-2xl font-black" style="color: var(--text-primary);">Buat Password Baru</h1>
            <p class="text-sm mt-1" style="color: var(--text-muted);">Data anda berhasil diverifikasi</p>
        </div>
        ...
        <div class="rounded-2xl p-8" style="background: var(--bg-card); backdrop-filter: blur(20px); border: 1px solid var(--border-main);">
            ...
            <form method="POST" action="{{ route('anggota.password.update') }}">
                ...
                <!-- Password -->
                <div class="mb-4">
                    <label class="block text-sm font-bold mb-2" style="color: var(--text-secondary);">Password Baru</label>
                    <input type="password" name="password"
                           class="w-full px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all"
                ...
                <!-- Confirm Password -->
                <div class="mb-6">
                    <label class="block text-sm font-bold mb-2" style="color: var(--text-secondary);">Konfirmasi Password Baru</label>
        ...
        <p class="text-center text-sm mt-5" style="color: var(--text-dimmed);">
            <a href="{{ route('anggota.login') }}" class="no-underline hover:opacity-80 font-semibold" style="color: var(--text-muted);">Batal dan kembali ke Login</a>
        </p>
    </div>
